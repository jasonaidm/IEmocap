...
from load_MOSI_data import get_data, analyze_data, train_data_generation  #process_train_data
...
dropout_word = Dropout(0.25)(word_att)
...
text_weight_input = Input(shape=(98,))
audio_weight_input = Input(shape=(98,))
...
r_0, r_1 = analyze_data(test_label_o, result)
print('final result: ')
